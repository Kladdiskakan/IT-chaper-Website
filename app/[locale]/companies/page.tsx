          ...
          <div className="lg:col-span-2 space-y-8">
            <article className="prose prose-lg max-w-none [&>section>p]:text-muted-foreground">
              ...
              <section>
                ...
                <ul>
                  <li>
                    <strong>{t("events.eventtypes.0")}</strong>{" "}
                    {t("events.eventdecription.0")}{" "}
                  </li>{" "}
                  <br />
                  <li>
                    <strong>{t("events.eventtypes.1")}</strong>{" "}
                    {t("events.eventdecription.1")}{" "}
                  </li>{" "}
                  <br />
                  <li>
                    <strong>{t("events.eventtypes.2")}</strong>{" "}
                    {t("events.eventdecription.2")}{" "}
                  </li>{" "}
                  <br />
                  <li>
                    <strong>{t("events.eventtypes.3")}</strong>{" "}
                    {t("events.eventdecription.3")}{" "}
                  </li>{" "}
                  <br />
                </ul>
              ...
              <section>
                ...
                <p>
                  {t("realitycheck.content.1")} {t("realitycheck.content.2")}
                </p>
                <br />
              </section>
              <section>
                ...
                <p>
                  {t("reception.content.2")} {t("reception.content.3")}
                </p>
                <br />
              </section>
              <section>
                ...
                <p>
                  <strong>{t("marketing.content.0")}</strong>,{" "}
                  {t("marketing.content.1")}
                </p>
